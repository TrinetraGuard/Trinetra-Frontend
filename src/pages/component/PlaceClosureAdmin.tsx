  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto p-4 md:p-6 text-gray-900">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <Badge variant="outline" className="border-gray-300 text-gray-800 bg-gray-50">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-5 gap-6 items-start">
        <Card className="xl:col-span-3 border border-gray-200 shadow-sm overflow-hidden">
              ...
              <div className="flex flex-wrap gap-2">
                {(
                  ...
                  <Button
                    ...
                    className={filter === key ? "bg-gray-900 hover:bg-gray-800 text-white" : ""}
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="px-3 py-3 align-top whitespace-nowrap">
                              {r.isClosed ? (
                                <Badge variant="secondary" className="font-medium bg-gray-800 text-white hover:bg-gray-800">
        ...
        <Card className="xl:col-span-2 border border-gray-200 shadow-sm overflow-hidden sticky top-4">
          <CardHeader className="border-b bg-gray-50">
          ...
          <CardContent className="pt-6 space-y-5">
            {!selected ? (
              <div className="text-sm text-gray-500 py-8 text-center border border-dashed border-gray-200 rounded-lg bg-gray-50">
              ...
              <>
                ...
                <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 flex gap-3">
                ...
                <div className="flex items-center justify-between gap-4 rounded-xl border border-gray-200 bg-gray-50/80 px-4 py-3">
                  ...
                  <button
                    ...
                    className={`relative inline-flex h-8 w-14 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-400 focus-visible:ring-offset-2 ${
                      draftClosed ? "bg-gray-900" : "bg-gray-300"
                    }`}
                  >
                    <span
                ...
                <div className="space-y-2">
                  <Label htmlFor="closed-reason">Reason for visitors {draftClosed && <span className="text-gray-700">*</span>}</Label>
                  <Textarea
                    id="closed-reason"
                    value={draftReason}
                    ...
                    className="min-h-[120px] disabled:bg-gray-100 disabled:text-gray-400"
                  />
                  {draftClosed && (
                ...
                {saveMsg && (
                  <p
                    className={`text-sm ${saveMsg.includes("Saved") || saveMsg.includes("within") ? "text-gray-700" : "text-red-600"}`}
                  >
                    {saveMsg}
                  </p>
                )}
